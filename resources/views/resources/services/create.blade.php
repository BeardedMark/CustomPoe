...
@section('title', env('APP_NAME') . ' : Создание объявления изгнанника')
@section('description', 'Создание нового объявления изгнанника в сообществе ' . env('APP_NAME') . ' для Path of Exile')
                ...
                <div class="col col-12 col-lg">
                    <div class="flex-col-21">
                        <div class="flex-col-8">
                            <h1 class="font-size-h1 decor-gold">Создание Объявления</h1>
                            <p class="font-size-lg font-color-second">
                                Создать новое Объявление изгнанника на сайте
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="pad-98">
        <div class="container">    
            <div class="row justify-content-center">
                <div class="col col-12 col-lg">
                    <form class="flex-col-13 flex-grow flex-start" action="{{ route('services.store') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="flex-col-5">
                            <label class="font-color-second" for="name">Название нового Объявления изгнанников</label>
